            ...
            <main class="c-wrapper-container">
                <div class="c-wrapper-paper">
                    <div class="c-wrapper-inner">
                        ...
                        <form class="p-inclusao-form" action="lattes_xml_to_elastic_dedup.php" method="post" accept-charset="utf-8" enctype="multipart/form-data" title="Formulário de Inserção de XML do Lattes">
                        ...
                        <form class="p-inclusao-form" action="include_ppg.php" method="post" accept-charset="utf-8" enctype="multipart/form-data" title="Formulário de Inserção de um Programa de Pós Graduação">
                        ...
                        <div class="alert alert-danger" role="alert">
                            Excluir todos os dados! Atenção, essa tarefa é irreversível! <a href="#" onclick="confirmDelete()">Clique aqui</a>
                        </div>
                        ...
                        <p><a href="tools/export_old.php?<?php echo $_SERVER["QUERY_STRING"] ?>&format=authorNetworkWithoutPapers">Exportar
                        ...
                        <p><a href="tools/openalex_get_record.php?size=500">Coletar 500 registros no Openalex com DOI (É
                                necessário
                                repetir este procedimento até zerar a quantidade de registros)</a></p>
                        <p><a href="tools/openalex_get_doi.php?size=10">Atualizar 10 registros no Openalex que não possuem
